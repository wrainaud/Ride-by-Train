				...
				.ready(function () {
																				...
																				snapshot
																								.forEach(function (childSnapshot) {
																												...
																												database
																																...
																																.update({lastupdated: currentTime});
																								});
																});
								}
								...
								function updateTrains(childSnapshot) {
												...
												var trainName = childSnapshot
																.val()
																.name;
												var trainDestination = childSnapshot
																.val()
																.destination;
												var trainTime = childSnapshot
																.val()
																.time;
												var trainFrequency = childSnapshot
																.val()
																.frequency;
												...
												newAddition
																...
																.append($('<button>').addClass("btn btn-danger delete glyphicon glyphicon-ban-circle").attr("data-train", key).html($('<i>')));
								...
								function trainChange(childSnapshot) {
												...
												$('.' + key).empty();
												$('.' + key).append($('<td>').text(trainName), $('<td>').text(trainDestination), $('<td>').text(nextTrainTime), $('<td>').text(trainFrequency), $('<td>').text(timeTotal), $('<button>').addClass("btn btn-danger delete glyphicon glyphicon-ban-circle").attr("data-train", key).html($('<i>')));
